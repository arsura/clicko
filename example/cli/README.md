...
```bash
clicko --uri "clickhouse://default:@localhost:9000/default" --dir example/cli/migrations up
```

Check current migration status:

```bash
clicko --uri "clickhouse://default:@localhost:9000/default" --dir example/cli/migrations status
```

Apply migrations up to version 2:

```bash
clicko --uri "clickhouse://default:@localhost:9000/default" --dir example/cli/migrations up-to 2
```

Rollback the last applied migration:

```bash
clicko --uri "clickhouse://default:@localhost:9000/default" --dir example/cli/migrations down
```

Rollback all migrations:

```bash
clicko --uri "clickhouse://default:@localhost:9000/default" --dir example/cli/migrations reset
```
